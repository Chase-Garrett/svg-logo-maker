...
class Text {
    ...
    render() {
        if (this.characters.length > 3) {
            ...
            return `<text x="150" y="100" fill="${this.textColor}" font-size="60" text-anchor="middle" dominant-baseline="central">${this.characters}</text>`;
            ...
            return `<text x="150" y="70%" fill="${this.textColor}" font-size="40" text-anchor="middle" dominant-baseline="central">${this.characters}</text>`;
        }
    }
}
